...
/* package DB-EXAMPLE-0.1.0.0 */
#ifndef VERSION_DB_EXAMPLE
#define VERSION_DB_EXAMPLE "0.1.0.0"
#endif /* VERSION_DB_EXAMPLE */
#ifndef MIN_VERSION_DB_EXAMPLE
#define MIN_VERSION_DB_EXAMPLE(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_DB_EXAMPLE */
...
#define CURRENT_COMPONENT_ID "DB-EXAMPLE-0.1.0.0-inplace-DB-EXAMPLE"
